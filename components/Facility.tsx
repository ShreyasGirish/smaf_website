...
const Facility = () => {
  ...
  // CRITICAL PATH FIX: Pre-resolve the asset strings using Vite's BASE_URL pattern
    ...
    <section id="facility" className="py-28 bg-[#FCFBF7]">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          ...
          <div 
            onClick={() => setActiveImage({ src: imgFacility, alt: "Advanced Processing Facility" })}
          ...
          >
            <img
              ...
              className="w-full h-full object-cover transform group-hover/facility:scale-105 transition duration-700 ease-out"
            />
          ...
          <div 
            onClick={() => setActiveImage({ src: imgFarmerNetwork, alt: "Integrated Farmer Sourcing Network" })}
          ...
          >
            <img
              ...
              className="w-full h-full object-cover transform group-hover/farmers:scale-105 transition duration-700 ease-out"
            />
          ...
          {/* CARD 3: BRINE TANKS */}
          <div 
            onClick={() => setActiveImage({ src: imgBrineTanks, alt: "Industrial Brine Tank Infrastructure" })}
          ...
          >
            <img
              ...
              className="w-full h-full object-cover transform group-hover/brinetanks:scale-105 transition duration-700 ease-out"
            />
          ...
          <div 
            onClick={() => setActiveImage({ src: imgBrineClean, alt: "Brine Tank Fermentation Process Quality Control" })}
          ...
          >
            <img
              ...
              className="w-full h-full object-cover transform group-hover/fermentation:scale-105 transition duration-700 ease-out"
            />
