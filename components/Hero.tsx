...
// ✅ CORRECT IMAGE IMPORT (this is the fix)
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl font-light">
            Empowering 1,200+ smallholder farmers to deliver premium-grade
            gherkins and jalapeños to the world’s leading food brands with
            absolute traceability.
          </p>

          <button
            onClick={() => scrollToSection('products')}
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-5 rounded-2xl font-bold flex items-center gap-3 transition-all shadow-xl shadow-emerald-900/40 active:scale-95"
          >
